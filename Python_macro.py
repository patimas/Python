...
def _configSave():
    ...
    #Tab Query (1)
    configValueInput['tab9_en_user'] = tab9_en_user.get()
    configValueInput['tab9_en_pass'] = tab9_en_pass.get()

    # Tab Config (6)
    for i in range(len(tab6Entries)):
        configValueInput["tab6_En_List"+str(i)] = tab6Entries[i].get()

    #Tab Query (7)
    for i in range(len(tab7Txts)):
        configValueInput["tab7_tx_area"+str(i)] = tab7Txts[i].get(1.0, END)
...
def _configSet():
    ...
    try:
        # print("configSet Start!!")
        # print(configValueRead)

        print(configValueRead)
        #Tab Query (1)
        if "tab9_en_user" in configValueRead :
            tab9_en_user.insert(END, configValueRead['tab9_en_user'])
        if "tab9_en_pass" in configValueRead :
            tab9_en_pass.insert(END, configValueRead['tab9_en_pass'])

        # Tab Config (6)
        for i in range(len(tab6Entries)):
            tab6Entries[i].insert(0,configValueRead["tab6_En_List"+str(i)])

        #Tab Query (7)
        for i in range(len(tab6Entries)):
            if 'tab7_tx_area'+str(i)  in configValueRead:
                tab7Txts[i].insert(END, configValueRead['tab7_tx_area'+str(i)])
...
def gridHide(val):
    ...
    for i in range(10):
        tab7Txts[i].grid_forget()
        if val == str(i+1) :
            tab7Txts[i].grid(row=0, column=0)
...
for i in range(tab6RowCount):
    for j in range(tab6ColCount):
        stringVar = StringVar()
        tab6StringVars.append(stringVar)

        en = ttk.Entry(tab6LFrame00, textvariable=tab6StringVars)
        en.grid(row=i+1, column=j, padx=8, pady=4)
        tab6Entries.append(en)
...
ttk.Button(tab7LFrame00, text="1", width=3, command=lambda : gridHide('1')).grid(row=0, column=1)
ttk.Button(tab7LFrame00, text="2", width=3, command=lambda : gridHide('2')).grid(row=0, column=2)
ttk.Button(tab7LFrame00, text="3", width=3, command=lambda : gridHide('3')).grid(row=0, column=3)
ttk.Button(tab7LFrame00, text="4", width=3, command=lambda : gridHide('4')).grid(row=0, column=4)
ttk.Button(tab7LFrame00, text="5", width=3, command=lambda : gridHide('5')).grid(row=0, column=5)
ttk.Button(tab7LFrame00, text="6", width=3, command=lambda : gridHide('6')).grid(row=1, column=1)
ttk.Button(tab7LFrame00, text="7", width=3, command=lambda : gridHide('7')).grid(row=1, column=2)
ttk.Button(tab7LFrame00, text="8", width=3, command=lambda : gridHide('8')).grid(row=1, column=3)
ttk.Button(tab7LFrame00, text="9", width=3, command=lambda : gridHide('9')).grid(row=1, column=4)
ttk.Button(tab7LFrame00, text="10", width=3, command=lambda : gridHide('10')).grid(row=1, column=5)
...
############################################################
# 접속정보
tab9LFrame00 = ttk.LabelFrame(tab9, text="Connenction", width=400)
tab9LFrame00.grid(row=0, column=0, padx=8, pady=4, sticky=tk.W)
tab9_lb_user = ttk.Label(tab9LFrame00, text="사용자:")
tab9_lb_user.grid(row=0, column=0)

varDbUserStr = StringVar()
tab9_en_user = ttk.Entry(tab9LFrame00, text='', textvariable=varDbUserStr)
tab9_en_user.grid(row=0, column=1, padx=4, pady=2)

tab9_lb_pass = ttk.Label(tab9LFrame00, text="비번:")
tab9_lb_pass.grid(row=0, column=2, padx=4, pady=2)

varDbPassStr = StringVar()
tab9_en_pass = ttk.Entry(tab9LFrame00, textvariable=varDbPassStr)
tab9_en_pass.grid(row=0, column=3, padx=4, pady=2)
...
# 이미지 경로
tab9LFrame01 = ttk.LabelFrame(tab9, text="Image Search", width=400)
tab9LFrame01.grid(row=1, column=0, padx=8, pady=4, sticky=tk.W)

tab9_Lb_Path1 = ttk.Label(tab9LFrame01, text="이미지1 : ")
tab9_Lb_Path1.grid(row=0, column=0)
vartab9Str1 = StringVar()
tab9_En_Path1 = ttk.Entry(tab9LFrame01, text='', textvariable=vartab9Str1)
tab9_En_Path1.grid(row=0, column=1, padx=4, pady=2)

tab9_Lb_Path2 = ttk.Label(tab9LFrame01, text="이미지2 : ")
tab9_Lb_Path2.grid(row=1, column=0)
vartab9Str2 = StringVar()
tab9_En_Path2 = ttk.Entry(tab9LFrame01, text='', textvariable=vartab9Str2)
tab9_En_Path2.grid(row=1, column=1, padx=4, pady=2)

tab9_Lb_Path3 = ttk.Label(tab9LFrame01, text="이미지3 : ")
tab9_Lb_Path3.grid(row=2, column=0)
vartab9Str3 = StringVar()
tab9_En_Path3 = ttk.Entry(tab9LFrame01, text='', textvariable=vartab9Str3)
tab9_En_Path3.grid(row=2, column=1, padx=4, pady=2)

tab9_Lb_Path4 = ttk.Label(tab9LFrame01, text="이미지4 : ")
tab9_Lb_Path4.grid(row=3, column=0)
vartab9Str4 = StringVar()
tab9_En_Path4 = ttk.Entry(tab9LFrame01, text='', textvariable=vartab9Str4)
tab9_En_Path4.grid(row=3, column=1, padx=4, pady=2)

tab9_Lb_Path5 = ttk.Label(tab9LFrame01, text="이미지5 : ")
tab9_Lb_Path5.grid(row=4, column=0)
vartab9Str5 = StringVar()
tab9_En_Path5 = ttk.Entry(tab9LFrame01, text='', textvariable=vartab9Str5)
tab9_En_Path5.grid(row=4, column=1, padx=4, pady=2)

tab9_Lb_Path6 = ttk.Label(tab9LFrame01, text="이미지6 : ")
tab9_Lb_Path6.grid(row=5, column=0)
vartab9Str6 = StringVar()
tab9_En_Path6 = ttk.Entry(tab9LFrame01, text='', textvariable=vartab9Str6)
tab9_En_Path6.grid(row=5, column=1, padx=4, pady=2)

tab9_Lb_Path7 = ttk.Label(tab9LFrame01, text="이미지7 : ")
tab9_Lb_Path7.grid(row=6, column=0)
vartab9Str7 = StringVar()
tab9_En_Path7 = ttk.Entry(tab9LFrame01, text='', textvariable=vartab9Str7)
tab9_En_Path7.grid(row=6, column=1, padx=4, pady=2)

tab9_Lb_Path8 = ttk.Label(tab9LFrame01, text="이미지8 : ")
tab9_Lb_Path8.grid(row=7, column=0)
vartab9Str8 = StringVar()
tab9_En_Path8 = ttk.Entry(tab9LFrame01, text='', textvariable=vartab9Str8)
tab9_En_Path8.grid(row=7, column=1, padx=4, pady=2)

tab9_Lb_Path9 = ttk.Label(tab9LFrame01, text="이미지9 : ")
tab9_Lb_Path9.grid(row=8, column=0)
vartab9Str9 = StringVar()
tab9_En_Path9 = ttk.Entry(tab9LFrame01, text='', textvariable=vartab9Str9)
tab9_En_Path9.grid(row=8, column=1, padx=4, pady=2)

tab9_Lb_Path10 = ttk.Label(tab9LFrame01, text="이미지10 : ")
tab9_Lb_Path10.grid(row=9, column=0, sticky=tk.W)
vartab9Str10 = StringVar()
tab9_En_Path10 = ttk.Entry(tab9LFrame01, text='', textvariable=vartab9Str10)
